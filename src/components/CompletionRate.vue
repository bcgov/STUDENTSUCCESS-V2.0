        ...
        this.def = {
          ...
          data: [
...

            {
              ...
              source: "provlvl",
              transform: [
                { type: "filter", expr: "datum.year == '2017/2018'" },
              ],
            },
              ...
              marks: [
                {
                  ...
                  encode: {
                    enter: {
                      ...
                      tooltip: {
                        signal:
                          "{'Average 25th Percentile':format(datum.percentile_25, '0.0%'),'Average 75th Percentile':format(datum.percentile_75, '0.0%')}",
                      },
                    },
                    update: {
              ...
              marks: [
                {
                  ...
                  encode: {
                    enter: {
                      description:
                        "below command turns off symbol if value is set to 'MSK'",
                      ...
                      tooltip: {
                        signal:
                          "{'District':datum.district,'Completion Rate':format(datum.value, '0.0%'),'Student Group':datum.subpop,                                                  'School    Year':datum.year,'Records':datum.records}",
                      },
                    },
                    update: {
                      yc: { signal: "plotWidth / 2" },
              ...
              marks: [
                {
                  ...
                  encode: {
                    enter: {
                      ...
                      tooltip: {
                        signal:
                          "{'District 5 year minimum':format(datum.min, '0.0%'),'District 5 year maximum':format(datum.max, '0.0%')}",
                      },
                    },
                    update: {
              ...
              marks: [
                {
                  ...
                  encode: {
                    enter: {
                      ...
                      tooltip: {
                        signal:
                          "{'District':datum.district,'Completion Rate':format(datum.value, '0.0%'),'Subpop':datum.subpop,                                                  'School    Year':datum.year,'Records':datum.records}",
                      },
                    },
                    update: {
              ...
              marks: [
                {
                  ...
                  encode: {
                    enter: {
                      ...
                      tooltip: {
                        signal:
                          "{'Student Group':datum.subpop,'Completion Rate':datum.tooltip,'School Year':datum.year,'Records':datum.tooltipR,'5-year range for this district':datum.min_max_tooltip,'Typical range across B.C. (middle 50% of districts)':datum.province_percentile_tooltip}",
                      },
                    },
                    update: {
                      yc: {
